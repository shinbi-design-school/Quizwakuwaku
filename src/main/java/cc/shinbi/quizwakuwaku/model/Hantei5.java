...
public class Hantei5 {
	...
	private static List<Result> getResultList() {
		Result[] results = {
				new Result(
						"５問中０点","解説<br><br>"
								+ "第１問 ワシントン・ウィザーズです<br><br>"
								+ "第２問 アイスミルクは乳固形分10％以上、うち乳脂肪分３％以上で植物油脂の添加が可能なものです。<br><br>"
								+ "第３問 呪術廻戦の主人公虎杖悠二は都立呪術高専の1年生<br><br>"
								+ "第４問 松中信彦さんがダイエーホークス時代の２００４年に三冠王を獲得されたのが最後。<br><br>"
								+ "第５問 ８人です<br>"
				),
				new Result(
						"５問中１点","解説<br><br>"
