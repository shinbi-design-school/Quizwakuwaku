...
public class Hantei5 {
	...
	private static List<Result> getResultList() {
		Result[] results = {
				new Result(
						...
						+ "第２問　アイスミルクは乳固形分10％以上、うち乳脂肪分３％以上で植物油脂の添加が可能なものです。<br>"
						+ "第３問　黄色いビートルが愛車<br>"
				...
				new Result(
						...
						"解説<br>"
						+ "第１問　ワシントン・ウィザーズです<br>"
						+ "第２問　アイスミルクは乳又はこれらを原料として製造した食品を加工し、又は主要原料としたものを凍結させたもののうち、乳固形分10％以上、うち乳脂肪分３％以上で植物油脂の添加が可能なものです。<br>"
						+ "第３問　黄色いビートルが愛車<br>"
						+ "第４問　松中信彦さんがダイエーホークス時代の２００４年に三冠王を獲得されたのが最後。<br>"
						+ "第５問　８人です<br>"
				),
	...
	private static List<Question> getQuestionList() {
		...
		question2.addItem(0, "乳固形分15％以上、うち乳脂肪分8％以上で植物油脂の添加が不可能なものもの");
		question2.addItem(1, "乳固形分15％以上、うち乳脂肪分3％以上で植物油脂の添加が可能なものもの");
		question2.addItem(2, "乳固形分10％以上、うち乳脂肪分8％以上で植物油脂の添加が不可能なものもの");
		question2.addItem(3, "乳固形分10％以上、うち乳脂肪分３％以上で植物油脂の添加が可能なものもの");
		list.add(question2);
